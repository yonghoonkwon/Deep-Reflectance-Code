...
* The code relies on [vlfeat](http://www.vlfeat.org/), and [matconvnet-1.0-beta18](http://www.vlfeat.org/matconvnet/download/), which should be downloaded and built before running the experiments. 
